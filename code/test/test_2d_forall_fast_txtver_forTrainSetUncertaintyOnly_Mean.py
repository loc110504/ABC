...
from utils import calculate_metric_percase, logInference, get_rgb_from_uncertainty, get_the_first_k_largest_components
...
def test_single_volume_2d_forTrainUncertainty(case_path, net, test_save_path, FLAGS, uncertainty_path_save):  
    ...
    org_img_path = find_org_nii(case_name, FLAGS.data_root_path)
